...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    return {
        title: lang === 'ne' ? 'आप्रवासन' : 'Immigration',
        description: lang === 'ne' ? 'युरोप आप्रवासन सम्बन्धी समाचार र जानकारी।' : 'News and info about Europe immigration.',
    };
}
...
export default async function ImmigrationPage({ params }: Props) {
    ...
    `)
        .eq('status', 'published')
        .eq('categories.slug', 'immigration')
        ...
        <div className="space-y-8 py-8">
            <div className="section-header">
                <h1 className="text-3xl md:text-4xl font-bold text-[var(--primary-900)]">
                    {lang === 'ne' ? 'आप्रवासन' : 'Immigration'}
                </h1>
                <p className="text-neutral-600 mt-2">
                    {lang === 'ne' ? 'युरोप आप्रवासन सम्बन्धी नीति र समाचार' : 'Policy and news about Europe immigration'}
                </p>
            </div>
