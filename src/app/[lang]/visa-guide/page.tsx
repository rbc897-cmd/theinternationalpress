...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    return {
        title: lang === 'ne' ? 'भिसा गाइड' : 'Visa Guide',
        description: lang === 'ne' ? 'युरोप भिसा आवेदन गर्ने तरिका।' : 'How to apply for Europe visa.',
    };
}
...
export default async function VisaGuidePage({ params }: Props) {
    ...
    // Redirecting to category list for now or showing specific content if needed
    // For this implementation, we treat it as a category view
        ...
        <div className="space-y-8 py-8">
            <div className="section-header">
                <h1 className="text-3xl md:text-4xl font-bold text-[var(--primary-900)]">
                    {lang === 'ne' ? 'भिसा गाइड' : 'Visa Guide'}
                </h1>
                <p className="text-neutral-600 mt-2">
                    {lang === 'ne' ? 'युरोप भिसा सम्बन्धी जानकारीमूलक लेखहरू' : 'Informative articles about Europe visa'}
                </p>
            </div>
