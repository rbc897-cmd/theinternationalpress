...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    return {
        title: lang === 'ne' ? 'युरोपमा जीवन' : 'Life in Europe',
        description: lang === 'ne' ? 'युरोपमा जीवनशैली र बसोबास सम्बन्धी जानकारी।' : 'Information about lifestyle and living in Europe.',
    };
}
        ...
        <div className="space-y-8 py-8">
            <div className="section-header">
                <h1 className="text-3xl md:text-4xl font-bold text-[var(--primary-900)]">
                    {lang === 'ne' ? 'युरोपमा जीवन' : 'Life in Europe'}
                </h1>
                <p className="text-neutral-600 mt-2">
                    {lang === 'ne' ? 'युरोपमा जीवनशैली र बसोबास सम्बन्धी जानकारीमूलक लेखहरू' : 'Informative articles about lifestyle and living in Europe'}
                </p>
            </div>
